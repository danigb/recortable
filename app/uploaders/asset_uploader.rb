...
class AssetUploader < CarrierWave::Uploader::Base
  ...
  # Include RMagick or ImageScience support: include CarrierWave::RMagick include CarrierWave::ImageScience
  ...
  def store_dir
    "recortable/#{model.class.to_s.underscore}/#{mounted_as}/#{model.id}"
  end
